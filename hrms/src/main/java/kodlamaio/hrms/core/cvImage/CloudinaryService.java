...
public class CloudinaryService implements ImageService {
    ...
    public CloudinaryService() {
        valuesMap.put("cloud_name","ddilwthbu" );
        valuesMap.put("api_key", "182962136828711" );
        valuesMap.put("api_secret","KiDvRH05pKXvBRgV_td9ln3y8yM" );
	...
	@Override
	public DataResult<Map> upload(MultipartFile multipartFileFile) throws IOException {
		 Map<String , Object > options = new HashMap<>();
	        var allowedFormats = Arrays.asList("png","jpg","jpeg");
	        options.put("allowed_formats",allowedFormats);
	        File file = convert(multipartFileFile);
	        Map result= null;
	        try {
